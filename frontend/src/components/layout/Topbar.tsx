  ...
  return (
    <header className="sticky top-0 z-20 flex h-14 items-center gap-4 border-b border-white/[0.06] bg-ink-950/70 px-6 backdrop-blur-xl">
      ...
      <div className="ml-auto flex items-center gap-3">
        <button className="group flex items-center gap-2 rounded-lg border border-white/[0.08] bg-white/[0.02] px-3 py-1.5 text-xs text-ink-400 transition-colors hover:border-white/15 hover:text-ink-200">
          <Search size={13} />
          <span>Search…</span>
